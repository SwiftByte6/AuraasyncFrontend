...
const img = (g: Gender, shape: FaceShape, length: HairLength, styleName: string) => {
  ...
  const styleNameMap: Record<string, string> = {
    ...
    // Men Round Long
    "Men Round Long Top + Short Sides (Disconnected)": "Long Top + Short Sides (Disconnected)",
    "Men Round Shoulder‑length with Side Part": "Shoulder‑length with Side Part",
    "Men Round Slick Back (longer on top)": "Slick Back (longer on top)",
    "Men Round Wavy layers pushed back": "Wavy layers pushed back",
    "Men Round Man Bun / Top Knot (high)": "Man Bun / Top Knot (high)",
    ...
    "Men Square Shoulder‑Length Waves (pushed back/side part)": "Shoulder‑Length Waves (pushed back/side part)",
    "Men Square Layered Long Hair with Fade": "Layered Long Hair with Fade",
    "Men Square Man Bun / Top Knot (tight sides)": "Man Bun / Top Knot (tight sides)",
    ...
    "Men Heart Light Fringe / Forward Bangs": "Light Fringe / Forward Bangs",
    ...
    "Men Heart Long Fringe with Layers": "Long Fringe with Layers",
    "Men Heart Chin‑Length Flow (bold look)": "Chin‑Length Flow (bold look)",
    ...
    // Men Diamond Medium
    "Men Diamond Medium Side Part with Layers": "Medium Side Part with Layers",
    "Men Diamond Textured Quiff (not too high)": "Textured Quiff (not too high)",
    "Men Diamond Medium Undercut with Flow": "Medium Undercut with Flow",
    "Men Diamond Light Fringe / Forward Bangs": "Light Fringe / Forward Bangs",
    "Men Diamond Messy Medium Hair": "Messy Medium Hair",
    
    // Men Diamond Long
    "Men Diamond Wavy Shoulder‑Length Hair": "Wavy Shoulder‑Length Hair",
    "Men Diamond Layered Long Hair (messy look)": "Layered Long Hair (messy look)",
    "Men Diamond Man Bun with Loose Strands": "Man Bun with Loose Strands",
    "Men Diamond Long Fringe with Layers": "Long Fringe with Layers",
    "Men Diamond Chin‑Length Flow (bold look)": "Chin‑Length Flow (bold look)",
    ...
    "Men Oblong Textured Quiff (not too high)": "Textured Quiff (not too high)",
    "Men Oblong Medium Undercut with Flow": "Medium Undercut with Flow",
    "Men Oblong Light Fringe / Forward Bangs": "Light Fringe / Forward Bangs",
    "Men Oblong Messy Medium Hair": "Messy Medium Hair",
    
    // Men Oblong Long
    "Men Oblong Wavy Shoulder‑Length Hair": "Wavy Shoulder‑Length Hair",
    "Men Oblong Layered Long Hair (messy look)": "Layered Long Hair (messy look)",
    "Men Oblong Man Bun with Loose Strands": "Man Bun with Loose Strands",
    "Men Oblong Long Fringe with Layers": "Long Fringe with Layers",
    "Men Oblong Chin‑Length Flow (bold look)": "Chin‑Length Flow (bold look)",
    ...
    "Heart Shoulder‑length lob with layers": "Shoulder lenght lob with Layers",
    ...
    // Women Diamond Medium
    "Diamond Shoulder‑length layers": "Shoulder-Length Layers",
    "Diamond Medium cut with curtain bangs": "Medium Cut with Curtain Bangs",
    "Diamond Shag cut": "Shag Cut",
    "Diamond Side‑parted waves": "Side-Parted Waves",
    "Diamond Medium cut with side‑swept bangs": "Medium Cut with Side-Swept Bangs",
    
    // Women Diamond Long
    "Diamond Long layers with waves": "Long Layers with Waves",
    "Diamond Face‑framing layers": "Face-Framing Layers",
    "Diamond Long hair with curtain bangs": "Long Hair with Curtain Bangs",
    "Diamond Side‑parted long cut": "Side-Parted Long Cut",
    ...
    // Women Oblong Short
    "Oblong Pixie cut": "Pixie Cut",
    "Oblong Textured bob": "Textured Bob",
    "Oblong Side‑parted bob": "Side-Parted Bob",
    "Oblong Asymmetrical bob": "Asymmetrical Bob",
    "Oblong Short blunt bob": "Short Blunt Bob",
    
    // Women Oblong Medium
    "Oblong Shoulder‑length layers": "Shoulder-Length Layers",
    "Oblong Medium cut with bangs": "Medium Cut with Bangs",
    "Oblong Shag cut": "Shag Cut",
    "Oblong Side‑parted waves": "Side-Parted Waves",
    "Oblong Medium cut with side‑swept bangs": "Medium Cut with Side-Swept Bangs",
    
    // Women Oblong Long
    "Oblong Long layers with waves": "Long Layers with Waves",
    "Oblong Face‑framing layers": "Face-Framing Layers",
    "Oblong Long hair with bangs": "Long Hair with Bangs",
    "Oblong Side‑parted long cut": "Side-Parted Long Cut",
    "Oblong Loose curls": "Loose Curls",
    "Oblong V‑cut or U‑cut with waves": "V-Cut or U-Cut with Waves",
...
const DATA: DataMap = {
  Women: {
    ...
    Square: {
      Short: [
        { name: "Textured bob", description: "Jaw‑length or slightly longer; waves soften.", image: img("Women", "Square", "Short", "Square Textured bob") },
      ...
      Medium: [
        ...
        { name: "Shag cut", description: "Texture + volume soften face.", image: img("Women", "Square", "Medium", "Square Shag cut") },
    ...
    Heart: {
      ...
      Long: [
        { name: "Long layers with waves/curls", description: "Softens pointed chin; adds body.", image: img("Women", "Heart", "Long", "Heart Long layers with waves/curls") },
        { name: "Loose curls starting below chin", description: "Balances narrow lower face.", image: img("Women", "Heart", "Long", "Heart Loose curls starting below chin") },
        { name: "Face‑framing layers", description: "Draw attention to cheekbones.", image: img("Women", "Heart", "Long", "Heart Face‑framing layers") },
  ...
  Men: {
    ...
    Round: {
      ...
      Medium: [
        ...
        { name: "Brushed‑up Layers", description: "Messy height on top.", image: img("Men", "Round", "Medium", "Men Round Brushed‑up Layers") },
      ],
      Long: [
    ...
    Square: {
      Short: [
        { name: "Buzz Cut", description: "Emphasizes masculine jawline.", image: img("Men", "Square", "Short", "Men Square Buzz Cut") },
      ...
      Medium: [
        { name: "Classic Side Part", description: "Timeless; highlights structure.", image: img("Men", "Square", "Medium", "Men Square Classic Side Part") },
